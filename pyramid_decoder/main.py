...
def read_message(message_file_name):
...
def decode (message_file_name):
    ...
    message = read_message(message_file_name)
    message_dict = build_dictionary(message)
    clear_message = decode_message(message_dict)
...
if __name__ == '__main__':
    ...
    # decode message
    clear_message = decode(message_file_name)
    print(f'clear_message_decode: {clear_message}')
